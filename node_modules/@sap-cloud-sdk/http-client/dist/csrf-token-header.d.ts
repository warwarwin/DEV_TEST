 ...
 * @internal
 */
export declare function buildCsrfHeaders<T extends HttpRequestConfig>(destination: DestinationOrFetchOptions, requestConfig: Partial<T>): Promise<Record<string, any>>;
/**
