...
exports.isTokenExchangeEnabled = exports.exchangeToken = void 0;
...
async function exchangeToken(options) {
    const xsuaaServiceCredentials = (0, util_1.first)((0, environment_accessor_1.getServiceCredentialsList)('xsuaa'));
 ...
 */
function isTokenExchangeEnabled(options) {
...
exports.isTokenExchangeEnabled = isTokenExchangeEnabled;
