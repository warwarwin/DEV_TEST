...
async function getAllDestinationsFromDestinationService(options = {}) {
    ...
    const token = ((_a = (await destination_from_service_1.DestinationFromServiceRetriever.getSubscriberToken(options))) === null || _a === void 0 ? void 0 : _a.serviceJwt) ||
        (await destination_from_service_1.DestinationFromServiceRetriever.getProviderServiceToken(options));
    const destinationServiceUri = (0, destination_from_service_1.getDestinationServiceCredentials)().uri;
    const accountName = (0, subdomain_replacer_1.parseSubdomain)(token.decoded.iss);
