...
function getProtocolOrDefault(destination) {
    var _a, _b;
    const protocol = (_b = (_a = destination === null || destination === void 0 ? void 0 : destination.url) === null || _a === void 0 ? void 0 : _a.toLowerCase()) === null || _b === void 0 ? void 0 : _b.split('://');
    ...
    const casted = (0, protocol_1.getProtocol)(protocol[0]);
    if (casted) {
        return casted;
    }
