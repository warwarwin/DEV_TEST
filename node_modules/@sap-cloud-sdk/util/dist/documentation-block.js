...
function getIndentation(firstLine) {
    const removeStarting = firstLine === null || firstLine === void 0 ? void 0 : firstLine.replace(/^\n*/g, '');
    const countEmptySpaces = removeStarting === null || removeStarting === void 0 ? void 0 : removeStarting.search(/\S/);
