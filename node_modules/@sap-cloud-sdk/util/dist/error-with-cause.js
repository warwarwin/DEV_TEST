...
class ErrorWithCause extends Error {
    ...
    addStack(cause) {
        ...
        if (this.isAxiosError(cause)) {
            const response = ((_a = cause.response) === null || _a === void 0 ? void 0 : _a.data) ? ` - ${(_b = cause.response) === null || _b === void 0 ? void 0 : _b.data}` : '';
        ...
        else if (this.stack && (cause === null || cause === void 0 ? void 0 : cause.stack)) {
